...
=======
		<view class="uv-page__item">
			<text class="uv-page__item__title">当前任务</text>
>>>>>>> Stashed changes
...
=======
		...
		<!-- 当前工人被指派的任务列表 -->
		<view class="uv-page__item">
			<text class="uv-page__item__title">被指派的任务</text>
			<uv-collapse>
				<uv-collapse-item title="展开被指派的任务">
					<uv-collapse>
						<uv-collapse-item v-for="(task, index) in assignedTasks" :key="index"
							...
							<view class="task-content">
								...
								<view class="task-actions">
									...
									<uv-button @click="viewTaskDetail(task.id)"
										customStyle="margin-left: 10px;">详情</uv-button>
								</view>
							</view>
						</uv-collapse-item>
					</uv-collapse>
...
=======
		<view class="uv-page__item">
			<text class="uv-page__item__title">已完成的任务</text>
			<uv-collapse>
				<uv-collapse-item title="展开已完成的任务">
					<uv-collapse>
						<uv-collapse-item v-for="(task, index) in completedTasks" :key="index"
							:title="`开始时间: ${task.appearanceTime} 流水线: ${task.pipelineNumber} 缺陷类别: ${task.defectType}`">
							<view class="task-content">
								<view class="task-info">
									<text class="label">任务编号:</text>
...
=======
		...
		onLoad() {
			...
			this.completedTasks = [{
					...
					pipelineNumber: '101',
					description: '修复电路板',
					appearanceTime: '2024-01-01 10:00',
					defectType: '短路',
					defectCount: 1,
					completionTime: '2024-01-01 12:00'
				},
				{
					id: 5,
					pipelineNumber: '102',
					description: '更换电阻',
					appearanceTime: '2024-01-02 12:00',
					defectType: '电阻问题',
					defectCount: 4,
					completionTime: '2024-01-02 14:00'
				}
			]
			this.$nextTick(() => {
				// 再次调用 init 重新初始化内部高度
